...
# Format code script for Swift formatting and linting
# This script runs SwiftFormat and SwiftLint to auto-fix code formatting and style issues

set -e  # Exit on any error

echo "🔧 Running Swift formatting and linting..."
...
echo "Your code is now formatted. Please review the changes and commit them."